	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfo": "Display _START_ to _END_ of _TOTAL_ Records",
				"sInfoEmpty": "Display 0 to 0 of 0 Records",
			 ...
			 */
			//this.aLengthMenu = [ 10, 20, 50, 100 ];
			this.aLengthMenu = [ [ 10, 20, 50, 100, -1 ], [ 10, 20, 50, 100, 'All' ] ];
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" size="31" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" '+sName+' class="input">';
			var i, iLen;
